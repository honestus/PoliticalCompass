...
from textual_features_extraction import extract_emojis, extract_emoticons, extract_mentions, extract_repeated_punctuation_marks, extract_url
from text_replacement import replace_features_in_text, replace_features_from_raw_text
#from feature_extraction import search_badwords_tokens_greedy
from LexiconMatcher import *
from text_utils import is_upper_word
...
"""
    ...
    def __get_sentences_split_punctuation__(self) -> list[str]:
        ...
        curr_text = replace_features_from_raw_text(self.text, sorted_features=punctuation_features)
